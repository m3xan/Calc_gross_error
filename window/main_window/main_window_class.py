...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, user_name):
        ...
        self.action_save_as.setCheckable(True)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/action/Settings_30027.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_setting_window.setIcon(icon9)
        self.action_calc = QAction(MainWindow)
        self.action_calc.setObjectName(u"action_calc")
        ...
        self.combo_box_selection_data.setEnabled(False)
        ...
        self.list_widget_value = QListWidget(self.dockWidgetContents)
        self.list_widget_value.setObjectName(u"list_widget_value")
        self.list_widget_value.setEnabled(False)
        sizePolicy4 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Expanding)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.list_widget_value.sizePolicy().hasHeightForWidth())
        self.list_widget_value.setSizePolicy(sizePolicy4)
        self.list_widget_value.setMinimumSize(QSize(300, 0))
        self.list_widget_value.setMaximumSize(QSize(400, 16777215))
        ...
        self.list_widget_answer.setEnabled(False)
        sizePolicy4.setHeightForWidth(self.list_widget_answer.sizePolicy().hasHeightForWidth())
        self.list_widget_answer.setSizePolicy(sizePolicy4)
        self.list_widget_answer.setMinimumSize(QSize(300, 0))
        self.list_widget_answer.setMaximumSize(QSize(400, 60))
        self.list_widget_answer.setContextMenuPolicy(Qt.CustomContextMenu)

        self.verticalLayout.addWidget(self.list_widget_answer)
        ...
        self.push_button_add_data.setEnabled(False)
        self.push_button_add_data.setMinimumSize(QSize(0, 0))
        self.push_button_add_data.setMaximumSize(QSize(16777215, 16777215))
        self.push_button_add_data.setCheckable(False)
        self.push_button_add_data.setChecked(False)
        self.push_button_add_data.setAutoRepeat(False)
        self.push_button_add_data.setAutoExclusive(False)
        self.push_button_add_data.setAutoDefault(False)
        self.push_button_add_data.setFlat(False)
        ...
        self.push_button_delite_data.setEnabled(False)
        ...
        self.push_button_create_calc.setEnabled(False)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/file.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.menu_5.addAction(self.action_calc)

        self.retranslateUi(MainWindow)

        self.push_button_add_data.setDefault(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_setting_window.setText(QCoreApplication.translate("MainWindow", u"\u041e\u0431\u0449\u0438\u0435", None))
        self.action_calc.setText(QCoreApplication.translate("MainWindow", u"\u0420\u0430\u0441\u0447\u0451\u0442", None))
