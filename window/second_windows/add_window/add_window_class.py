...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy1.setVerticalStretch(55)
        ...
        sizePolicy1.setHeightForWidth(self.push_button_esc.sizePolicy().hasHeightForWidth())
        self.push_button_esc.setSizePolicy(sizePolicy1)
